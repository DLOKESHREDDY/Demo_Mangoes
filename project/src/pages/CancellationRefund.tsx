    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-green-50 rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a
            href="mailto:ullavapadumangoes@gmail.com"
            className="flex items-center gap-3 bg-white p-4 rounded-lg hover:shadow-md transition-shadow"
          >
            <Mail className="w-6 h-6 text-green-600" />
            <div>
              <h3 className="font-semibold">Email Us</h3>
              <p className="text-sm text-gray-600">ullavapadumangoes@gmail.com</p>
            </div>
          </a>
          <a
            href="https://wa.me/919701722419"
            target="_blank"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  ...
                  <li>Email the photos to ullavapadumangoes@gmail.com</li>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <span>ullavapadumangoes@gmail.com</span>
              </li>
              <li className="flex items-center gap-2">
                <Camera className="w-5 h-5 text-green-600" />
                <span>WhatsApp: +91 970-172-2419</span>
              </li>
            </ul>
          </div>
        </section>
