  ...
  return (
    <div className="max-w-4xl mx-auto prose prose-green">
      ...
      <section className="mb-8">
        ...
        <p>
          By accessing and using Ullavapadu Mangoes, you accept and agree to be bound by these
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          property rights owned by Ullavapadu Mangoes.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-none pl-6 mb-4">
          <li>Email: ullavapadumangoes@gmail.com</li>
          <li>Phone: +91 970-172-2419</li>
        </ul>
      </section>
